...
private:
	...
	std::pair<uint8_t, uint8_t> updateConstraintsOfNeighbour(
	...
	bool generateCollapsedGrid(int start_index, size_t num_cells_to_solve);
...
public:
	...
	std::vector<uint8_t> getValidCellsForPattern(
	...
	bool isGridCollapsed() { return num_collapsed_cells == total_cells; }
};