...
void WFCCore::prepareWFCSolver(
		size_t output_width, size_t output_height, bool force_boundary_patterns) {
...
bool WFCCore::generateCollapsedGrid(
		size_t start_index, CellSelectionStrategy cell_selection_strategy) {
